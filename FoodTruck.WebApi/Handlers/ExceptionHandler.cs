...
namespace FoodTruck.WebApi.Handlers
{
    public class ExceptionHandler : IExceptionHandler
    {
        ...
        private static ProblemDetails CreateProblemDetails(Exception exception)
        {
            ...
            {
                NotFoundException => CreateProblemDetails(StatusCodes.Status400BadRequest, "Not Found", exception.Message),
                CustomValidationException => CreateProblemDetails(StatusCodes.Status400BadRequest, "Validation error", "One or more validation errors occured"),
